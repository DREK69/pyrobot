...
async def start(lel, message):
    ...
    but = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton("❓ 𝘾𝙤𝙢𝙢𝙖𝙣𝙙 𝙃𝙚𝙡𝙥 ❗️", callback_data="mem_help")],
            [InlineKeyboardButton("𝙏𝙚𝙧𝙢𝙨 𝘼𝙣𝙙 𝘾𝙤𝙣𝙙𝙞𝙩𝙞𝙤𝙣𝙨❗️", callback_data="mem_terms")],
            [
    ...
    if "tutorial" in k:
        ...
        await app.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("How To Use Me", callback_data="mem_tutorial")]]
            ),
        )
