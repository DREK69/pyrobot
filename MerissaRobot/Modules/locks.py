...
LOCK_HANDLER = CommandHandler("lock", lock, block=False)
UNLOCK_HANDLER = CommandHandler("unlock", unlock, block=False)
LOCKED_HANDLER = CommandHandler("locks", list_locks, block=False)
