...
# from MerissaRobot.Database.sql import cust_filters_sql as filtersql
# import MerissaRobot.Database.sql.welcome_sql as welcsql
import MerissaRobot.Database.sql.locks_sql as locksql
import MerissaRobot.Database.sql.notes_sql as sql

# from MerissaRobot.Modules.rules import get_rules
...
def export_data(update, context):
    ...
    with open("MerissaRobot{}.txt".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("MerissaRobot{}.txt".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `MerissaRobot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("MerissaRobot{}.txt".format(chat_id))  # Cleaning file
