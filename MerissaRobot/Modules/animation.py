...
BRAINANIMATION_HANDLER = DisableAbleCommandHandler(
    "brain", brainanimation, run_async=True
)
POLICEANIMATION_HANDLER = DisableAbleCommandHandler(
    "police", policeanimation, run_async=True
)
