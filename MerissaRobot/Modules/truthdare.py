...
TRUTH = (
    ...
    "If you had to choose between going naked or having your thoughts appear in thought bubbles above your head for evermerissa to read, which would you choose?",
...
DARE = (
    ...
    "Empty out your wallet/purse and show evermerissa what's inside",
    "Do your best sexy crawl",
    "Pretend to be the person to your right for 10 minutes",
    "Eat a snack without using your hands",
    "Say two honest things about evermerissa else in the group",
    "Twerk for a minute",
    "Try and make the group laugh as quickly as possible",
    "Try to put your whole fist in your mouth",
    "Tell evermerissa an embarrassing story about yourself",
