...
\n\nOur privacy policy may change from time to time. If we make any material changes to our policies, we will place a prominent notice on https://t.me/MerissaxUpdates.
"""
                ...
                [
                    [
                        InlineKeyboardButton(
                            text="Privacy Policy", callback_data="policy_"
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            text="Retrieve data", callback_data="policy_data"
                        ),
                        InlineKeyboardButton(
                            text="Delete data", callback_data="policy_datadel"
                        ),
                    ],
                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            callback_data="policy_wiwc",
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            text="Why we collect it", callback_data="policy_wwci"
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            text="What we do", callback_data="policy_wwd"
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            text="What we DO NOT do", callback_data="policy_wwdnd"
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            text="Rights to process", callback_data="policy_rtp"
                        )
                    ],
                ]
            ),
...
This action **CANNOT** be undone.""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Yes, delete all my data.", callback_data="policy_del"
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            text="No, I changed my mind!", callback_data="cancel_"
                        )
                    ],
                ]
            ),
